...
{
    private static final Log   logger                      = LogFactory.getLog(DateUtil.class); // Logger for this class
    public static final String YEAR_FORMAT                 = "yyyy";                           // 년도 포맷 yyyy(4자리)
    public static final String MONTH_FORMAT                = "MM";                             // 월 포맷 MM(2자리)
    public static final String DATE_FORMAT                 = "dd";                             // 날짜 포맷 dd(2자리)
    public static final String YEAR_MONTH_FORMAT           = "yyyyMM";                         // 년월 포맷 yyyyMM(6자리)
    public static final String DEFAULT_DATE_FORMAT         = "yyyyMMdd";                       // 년월일 포맷 yyyyMMdd(8자리)
    public static final String DOT_MONTH_FORMAT            = "yyyy.MM";                        // 년월 포맷 yyyy.MM(6자리 콤마)
    public static final String DOT_DATE_FORMAT             = "yyyy.MM.dd";                     // 년월일 포맷 yyyy.MM.dd(8자리
                                                                                                // 콤마)
    public static final String DASH_DATE_FORMAT            = "yyyy-MM-dd";                     // 년월일 포맷 yyyy-MM-dd(8자리
                                                                                                // 대쉬)
    public static final String DEFAULT_DATETIME_FORMAT     = "yyyyMMddHHmmssSSS";              // 년월일시분초밀리초
                                                                                                // yyyyMMddHHmmssSSS(17자리)
    public static final String DEFAULT_TIMESTAMP_FORMAT    = "yyyyMMddHHmmss";                 // 년월일시분초
    public static final String NOT_SS_DATETIME_FORMAT    = "yyyyMMddHHmm";                 // 년월일시분초
                                                                                                // yyyyMMddHHmmss(14자리)
    public static final String DOT_DATETIME_FORMAT         = "yyyy.MM.dd HH:mm";               // 년월일시분 yyyy.MM.dd
                                                                                                // HH:mm
    public static final String DASH_DATETIME_FORMAT        = "yyyy-MM-dd HH:mm";               // 년월일시 yyyy-MM-dd HH:mm
    public static final String DOT_TIMESTAMP_FORMAT        = "yyyy.MM.dd HH:mm:ss";            // 년월일시 yyyy.MM.dd
                                                                                                // HH:mm:ss
    public static final String DASH_TIMESTAMP_FORMAT       = "yyyy-MM-dd HH:mm:ss";            // 년월일시 yyyy-MM-dd
                                                                                                // HH:mm:ss
    public static final String DEFAULT_TIME_FORMAT         = "HHmmss";                         // 시분초 HHmmss(6자리)
    public static final String COLONE_TIME_FORMAT          = "HH:mm:ss";                       // 시분초 HH:mm:ss
    public static final String DEFAULT_TIME_MILLS_FORMAT   = "HHmmssSSS";                      // 시분초밀리초 HHmmssSSS
    public static final String COLONE_TIME_MILLS_FORMAT    = "HH:mm:ss.SSS";                   // 시분초밀리초 HH:mm:ss.SSS
    public static final String KO_YEAR_FORMAT              = "yyyy년";                          // yyyy년
    public static final String KO_MONTH_FORMAT             = "MM월";                            // MM월
    public static final String KO_YEAR_MONTH_FORMAT        = "yyyy년 MM월";                      // yyyy년 MM월
    public static final String QUOTATION_YEAR_FORMAT       = "''yy";                           // ''yy QUOTATION
    public static final String QUOTATION_YEAR_MONTH_FORMAT = "''yy.MM";                        // ''yy.MM QUOTATION
    public static final String CARRY_OVER_MONTH            = "13";                             // 이월 (예산 집행 시 다음년도에 집행된
                                                                                                // 예산 집행에 대한 표준 년월의 월을
                                                                                                // 표현)
    public static final int    BEFORE_DATE_FLAG            = 0;                                // 이전 날짜 플래그
    public static final int    AFTER_DATE_FLAG             = 1;                                // 이후 날짜 플래그
    public static final long   ONE_DAY_MS                  = 24 * 60 * 60 * 1000;              // 1일을 밀리초로 환산한 값
    ...
    {
        Calendar calendar = Calendar.getInstance();
        SimpleDateFormat formatter = new SimpleDateFormat(DEFAULT_TIMESTAMP_FORMAT);
    ...
    {
        return new java.sql.Date(convertStringToDate(getCurrentDate(), DEFAULT_DATE_FORMAT).getTime());
    }
    ...
    {
        return new java.sql.Date(convertStringToDate("99991231", DEFAULT_DATE_FORMAT).getTime());
    }
    ...
    public static java.sql.Date[] getBeforeAfterSqlDates(Date baseDate)
    {
        ...
        generatedDates[BEFORE_DATE_FLAG] = new java.sql.Date(baseTime - ONE_DAY_MS);
        generatedDates[AFTER_DATE_FLAG] = new java.sql.Date(baseTime + ONE_DAY_MS);
    ...
    public static String convertStringToString(String strDate, String beforeFormat, String afterFormat)
    {
        ...
        {
            logger.error("DateUtil.convertStringToTimestamp : " + "사이즈가 다름");
            return null;
        }
    ...
    /**
     * <p>
     * DEFAULT_DATE_FORMAT형태의 String데이타를 java.util.Date로 변환 (첫번째 파라미터와 두 번재 파라미터 포맷이 같아야 함)
     * </p>
     * 
     * <pre>
     * String strDate = &quot;20081009&quot;;// YYYYMMDD 형태
    ...
    {
    	return DateUtil.convertStringToDate(strDate, DateUtil.DEFAULT_DATE_FORMAT);
    }
     ...
     * String strDate = &quot;2008-10-09&quot;;
     * String format = DateUtil.DASH_DATE_FORMAT; // YYYY-MM-DD 형태
     * java.util.Date convertStringToDate = DateUtil
     * </pre>
     * 
     * @return Date
     */
     ...
     * String strDate = &quot;2008-10-09&quot;;
     *                                String format = DateUtil.DASH_DATE_FORMAT; // YYYY-MM-DD 형태
     *                                                                           java.sql.Date convertStringToSqlDate = DateUtil
    ...
    /**
     * <p>
     * java.util.Date인 데이타를 DEFAULT_DATE_FORMAT에 맞게 String으로 변환
     * </p>
     * 
     * <pre>
     * java.util.Date date = calendar.getTime();
     * String convertDateToString = DateUtil.convertDateToString(date);
     * convertDateToString = 20081009
     * </pre>
     * 
     * @return String
     */
    ...
    {
        return DateUtil.convertDateToString(date, DateUtil.DEFAULT_DATE_FORMAT);
    }
    ...
    /**
     * Date.getString()=2010-06-25 12:24:16.0 > 2010-06-25 12:24:16
	 * 불필요 문자 제거
     * */
    ...
    {
        String date1 = convertStringToString(compareDate1, dateFormat, YEAR_FORMAT);
        String date2 = convertStringToString(compareDate2, dateFormat, YEAR_FORMAT);
    ...
    public static boolean isBetweenYear(int comDate, String compareDate1, String compareDate2, String dateFormat)
    {
        ...
        int date1 = Integer.parseInt(convertStringToString(compareDate1, dateFormat, YEAR_FORMAT));
        int date2 = Integer.parseInt(convertStringToString(compareDate2, dateFormat, YEAR_FORMAT));
     ...
     *                                                                    boolean isBeforeDate = DateUtil.isBeforeDate(
     ...
     *                                                                    boolean isAfterDate = DateUtil.isAfterDate(baseDate,
     *                                                                                                compareDate);
     * </pre>
     * 
     * @return boolean
     ...
     *                                                                         boolean isSameDate = DateUtil.isSameDate(
     *                                                                                                    compareDate1,
     *                                                                                                    compareDate2);
     * </pre>
     * 
     ...
     * java.util.Date compareDate1 = null;
     *                                     java.util.Date compareDate2 = null;
     *                                                                         boolean isSameMonth = DateUtil.isSameMonth(
     *                                                                                                     compareDate1,
     *                                                                                                     compareDate2);
     * </pre>
     * 
     ...
     * java.util.Date compareDate1 = null;
     *                                     java.util.Date compareDate2 = null;
     *                                                                         boolean isSameYear = DateUtil.isSameYear(
     *                                                                                                    compareDate1,
     *                                                                                                    compareDate2);
     * </pre>
     * 
     ...
     * @return boolean
     */
    private static boolean isSame(Date compareDate1, Date compareDate2, int compareType)
    {
        String format = null;
        switch (compareType)
        {
     ...
     *                                                                                              boolean isInTimeRange = DateUtil
     *                                                                                                                            .isInTimeRange(
     *                                                                                                                                    startTime,
     *                                                                                                                                    endTime,
     *                                                                                                                                    baseTime);
    ...
    public static boolean isInTimeRange(Time startTime, Time endTime, Time baseTime)
    {
        ...
        {
            logger.error("입력 데이터를 확인해 주십시요.[startTime/endTime/baseTime은 널이 올수 없습니다.]");
            return false;
        }
    }
     ...
     * @return java.sql.Date
     */
    public static java.sql.Date addDay(java.util.Date baseDate, int addDay)
    {
     ...
     * @return java.sql.Date
     */
    public static java.sql.Date addMonth(java.util.Date baseDate, int addMonth)
    {
    ...
    private static java.sql.Date addDate(java.util.Date baseDate, int addDate, int dateType)
    {
        Calendar calendar = Calendar.getInstance();
     ...
     * 
     * <pre>
     * String searchMonth = &quot;200907&quot;;
     *                                String lastDateOfMonth = DateUtil.getLastDateOfMonth(baseDate);
     * </pre>
     * 
     * @return String
     */

    public static String getLastDateOfMonth(String searchMonth)
    {
        Calendar calendar = Calendar.getInstance();
        Date baseDate = convertStringToDate(searchMonth, DateUtil.YEAR_MONTH_FORMAT);
        ...
        return searchMonth + calendar.getActualMaximum(Calendar.DATE);
    }
